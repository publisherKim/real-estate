...
- 목적(=내용)이 반사회적인 법률행위는 무효이다.
- 갑은 을이 자신의 첩이되어주는 대가로 을에게 자기 소유의 건물 한채를 증여하기로 약정하였다.
    - 증여계약은 무효
- 일반적인 무효
    - 이행전: 이행할 필요 없음
    - 이행후: 부당이득 반환청구 O
- 반사회적 법률행위의 무효
    - 이행전: 이행할 필요 없음
    - 이행후: 부당이득 반환청구 X
- 을은 갑을 위하여 법정에서 증언을 하고 갑은 승소하면 그 대가로 자신의 토지의 절반을 을에게 주기로 약정하였다.
    - 소송에서 증언을 조건으로 통상 용인되는 수준을 넘는 대가를 받기로 한 약정은 반사회적 법률행위로서 무효이다.