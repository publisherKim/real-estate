...
- 개념 및 적용
    ...
    - 잔금비율
        ...
        - 잔금비율 = 1 - 상환비율
        - 연금의 현가계수 이용
- A는 부동산 자금을 마련하기 위해 20x1년 1월 1일 현재 2년 동안 매년 연말 2,000원을 불입하는 투자상품에 가입했다.
투자 상품의 이자(할인율)이 연 10% 이 상품의 현재 가치는?
    - 2000 / 1.1 + 2000 / 1.1 / 1.1

## 4주차 한 줄 마무리
- 임대료 통제는 높은선(x), 낮은 선(o) -> 초과수요(부족)
- 임대료 보조: 실질소득 증가 -> (저)주택수요 증가 -> (장기)공급 증가
- 공공임대주택: 직접개입, 임대료 차액 -> 임대료 보조효과
    - 영구임대 50년, 행복: 30년, 국민: 30년, 장기전세 20년
- 우하향하는 수요곡선과 우상향하는 공급곡선에서 조세 부과
    - 탄력적: 부담이 낮고, 비탄력적 부담이 크다.
    - 임대료 하락(x), 수요 또는 공급 증가 (x)
- 기대수익률: 객관적 수익률, 요구수익률: 주관적 수익률
- 위험 크다 -> 요구수익률(할인률)커진다. -> (현재시점의) 투자가치 낮다.
- 위험혐오적일수록 투자곡선의 기울기는 (급)하게 형성
- 비체계적 위험 가소(o), 체계적 위험 감소(x)
- 효율적 전선이 우상향 -> 위험과 수익은 (비례)
- 최적의 포트폴리오 -> 두 곡선의 (접점)
- 5년 후 10억 원이 예상되는 토지의 현가(10%) ? -> 일시불의 현가계수
- 현재 5억 원인 주택가격이 매년 3% 상승하면 10년 후? -> 일시불의 내가계수
- 주택담보대출에 대해 매기 동일한 원리금은 상환? 저당상수
- 일시불의 내가계수, 연금의 내가계수, 저당상수는 미래가치계수? (x)
- 잔금비율과 상환비율을 합하면 '0'이 된다.(x) 1이된다.