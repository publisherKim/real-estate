...
## 7주차 한 줄 마무리
- 개발에는 시공을 담당하는 행위 포함하지 않는다.
- 예비적 타당성분석: (개략적), 타당성분석: (구체적)
- 법률적 위험에는 토지이용규제와 같은 공법적 측면과 소유권의 변동 등에서 나타나는 사법적 측면의 위험이 있다. 
- 특정부동산의 수요·공급 분석: (시장)분석, 개별 부동산의 매매 또는 임대가능성 분석: (시장성) 분석
- 시장분석 -> 개발의 채택가능성 판단, 경제성 분석 -> 개발의 수익성 분석
- 사업위탁(수탁)방식: 소유권이전 하지 않는다. 토지소유자 명의로 한다.
- 토지신탁방식: 소유권 이전 한다. 신탁사 명의로 한다.
- 시설관리와 자산관리의 구분
- 자가관리: 기밀유지 양호 + 타성화 발생 -> 위탁관리는 반대
- 시장점유 마케팅(공급자 중심): STP 전략, 4P MIX 전략
- 부동산의 위취, 방위, 층 등에 따라 가격을 달리하는 전략 -> 신축가격전략
- 2개 이상 ~ 일체로 이용 -> 일괄평가, 1개 ~ 가치를 달리 -> 구분 평가
- 가치: 현재의 값, 가격: 과거의 값
- 가격발생요인 중 유효수요는 (구매력)이 수반된 수요를 말한다.
- 지역분석: 선행 -> 지역의 ~ -> 표준적 이용과 가격수준 판정
- 개별분석: 후행 -> 대상부동산의 ~ -> 최유효이용과 가격 판정
- 균형의 원칙: 내부 -> 기능적 감가 -> 개별분석에 적용
- 적합의 원칙: 외부 -> 경제적 감가 -> 지역분석에 적용
- 비용성 -> 원가방식, 시장성 -> 비교방식, 수익성 -> 수익방식
- 시산가액 -> 최종가액 아니다. 산술평균 아니다. 3면등가성 인정하지 않는다.